...
type OAuthToken struct {
	...
	xxx_hidden_Raw          map[string]string      `protobuf:"bytes,5,rep,name=raw" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_raceDetectHookData  protoimpl.RaceDetectHookData
	XXX_presence            [1]uint32
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
...
func (x *OAuthToken) GetRaw() map[string]string {
	if x != nil {
...
func (x *OAuthToken) SetRaw(v map[string]string) {
	x.xxx_hidden_Raw = v
}
...
const file_thrippy_v1_oauth_proto_rawDesc = "" +
	...
	"thrippy.v1\x1a\x1fgoogle/api/field_behavior.proto\"\xfe\x03\n" +
	"\vOAuthConfig\x12!\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\x02\x10\x03J\x04\b\a\x10\b\"\xf9\x01\n" +
	"\n" +
	"OAuthToken\x12\"\n" +
	...
	"token_type\x121\n" +
	"\x03raw\x18\x05 \x03(\v2\x1f.thrippy.v1.OAuthToken.RawEntryR\x03raw\x1a6\n" +
	"\bRawEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B+Z)github.com/tzrikka/thrippy-api/thrippy/v1b\beditionsp\xe9\a"

var file_thrippy_v1_oauth_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_thrippy_v1_oauth_proto_goTypes = []any{
	...
	nil,                 // 4: thrippy.v1.OAuthToken.RawEntry
}
var file_thrippy_v1_oauth_proto_depIdxs = []int32{
	...
	4, // 2: thrippy.v1.OAuthToken.raw:type_name -> thrippy.v1.OAuthToken.RawEntry
